...
ccss_background_t * 		ccss_block_new_background			(ccss_block_t *self);
...
ccss_border_t * 		ccss_block_new_border				(ccss_block_t *self);
ccss_color_t * 			ccss_block_new_border_color			(ccss_block_t *self);
ccss_border_style_type_t * 	ccss_block_new_border_style			(ccss_block_t *self);
double * 			ccss_block_new_border_width			(ccss_block_t *self);

ccss_border_stroke_t * 		ccss_block_new_border_bottom			(ccss_block_t *self);
ccss_color_t * 			ccss_block_new_border_bottom_color		(ccss_block_t *self);
ccss_border_style_type_t * 	ccss_block_new_border_bottom_style		(ccss_block_t *self);
double * 			ccss_block_new_border_bottom_with		(ccss_block_t *self);

ccss_border_stroke_t * 		ccss_block_new_border_left			(ccss_block_t *self);
ccss_color_t * 			ccss_block_new_border_left_color		(ccss_block_t *self);
ccss_border_style_type_t * 	ccss_block_new_border_left_style		(ccss_block_t *self);
double * 			ccss_block_new_border_left_width		(ccss_block_t *self);

ccss_border_stroke_t * 		ccss_block_new_border_right			(ccss_block_t *self);
ccss_color_t * 			ccss_block_new_border_right_color		(ccss_block_t *self);
ccss_border_style_type_t * 	ccss_block_new_border_right_style		(ccss_block_t *self);
double * 			ccss_block_new_border_right_width		(ccss_block_t *self);

ccss_border_stroke_t * 		ccss_block_new_border_top			(ccss_block_t *self);
ccss_color_t * 			ccss_block_new_border_top_color			(ccss_block_t *self);
ccss_border_style_type_t * 	ccss_block_new_border_top_style			(ccss_block_t *self);
double * 			ccss_block_new_border_top_width			(ccss_block_t *self);
...
ccss_background_t const * 		ccss_block_get_background			(ccss_block_t const *self);
...
ccss_border_t const * 			ccss_block_get_border				(ccss_block_t const *self);
ccss_color_t const * 			ccss_block_get_border_color			(ccss_block_t const *self);
ccss_border_style_type_t		ccss_block_get_border_style			(ccss_block_t const *self);
double					ccss_block_get_border_width			(ccss_block_t const *self);

ccss_border_stroke_t const * 		ccss_block_get_border_bottom			(ccss_block_t const *self);
ccss_color_t const * 			ccss_block_get_border_bottom_color		(ccss_block_t const *self);
ccss_border_style_type_t 		ccss_block_get_border_bottom_style		(ccss_block_t const *self);
double 					ccss_block_get_border_bottom_with		(ccss_block_t const *self);

ccss_border_stroke_t const * 		ccss_block_get_border_left			(ccss_block_t const *self);
ccss_color_t const * 			ccss_block_get_border_left_color		(ccss_block_t const *self);
ccss_border_style_type_t 		ccss_block_get_border_left_style		(ccss_block_t const *self);
double					ccss_block_get_border_left_width		(ccss_block_t const *self);

ccss_border_stroke_t const * 		ccss_block_get_border_right			(ccss_block_t const *self);
ccss_color_t const * 			ccss_block_get_border_right_color		(ccss_block_t const *self);
ccss_border_style_type_t		ccss_block_get_border_right_style		(ccss_block_t const *self);
double					ccss_block_get_border_right_width		(ccss_block_t const *self);

ccss_border_stroke_t const * 		ccss_block_get_border_top			(ccss_block_t const *self);
ccss_color_t const * 			ccss_block_get_border_top_color			(ccss_block_t const *self);
ccss_border_style_type_t 		ccss_block_get_border_top_style			(ccss_block_t const *self);
double					ccss_block_get_border_top_width			(ccss_block_t const *self);
